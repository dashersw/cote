...
module.exports = class DirectedRequester extends Requester {
  ...
  socketSend(...args) {
    ...
    let sock = requesterSock.socks[chosenNodeIndex]; // Enqueue if the correct sock did not connect yet/does not exist
    ...
    args.push(fn.id); // Remove responderId from message

    delete args[0].responderId; // Send over sock
